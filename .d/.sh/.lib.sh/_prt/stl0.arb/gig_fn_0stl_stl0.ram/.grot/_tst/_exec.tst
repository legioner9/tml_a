...
__gig_fn_0stl_stl0_TST() {
    ...
    local filename=${ST_RC_D_PATH}/.d/.arb/stl0.arb/gig_fn_0stl_stl0.ram/.grot/_tst/exec.tst
...
if ! __gig_fn_0stl_stl0_TST "$@"; then
    _st_exit "in fs= file://${ST_RC_D_PATH}/.d/.arb/stl0.arb/gig_fn_0stl_stl0.ram/.grot/_tst/exec._tst , line=${LINENO}: : EXEC_FAIL : '__gig_fn_0stl_stl0_TST ' : ${hint} : return 1"
    return 1
fi
