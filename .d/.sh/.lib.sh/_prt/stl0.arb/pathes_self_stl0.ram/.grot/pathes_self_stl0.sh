...
filename="${ST_RC_D_PATH}/.d/.arb/stl0.arb/pathes_self_stl0.ram/.grot/pathes_self_stl0.sh"
...
pathes_self_stl0() {
    ...
    #* local fn_data_dir=${ST_RC_D_DATA_PATH}/.d/.st_rc_d.data.d/pathes_self_stl0

    local fn_sh_file=${ST_RC_D_PATH}/.d/.arb/stl0.arb/pathes_self_stl0.ram/.grot/pathes_self_stl0.sh
    local d_name=$(dirname ${ST_RC_D_PATH}/.d/.arb/stl0.arb/pathes_self_stl0.ram/.grot/pathes_self_stl0.sh)
...
${NORMAL}"
    ...
    # local dir_fn_data=${ST_RC_D_DATA_PATH}/.d/.st_rc_d.data.d/pathes_self_stl0
    # echo -e "${GREEN}\$dir_fn_data = file://$dir_fn_data${NORMAL}"

    . ${fn_data_dir}/.sh/pathes.sh
