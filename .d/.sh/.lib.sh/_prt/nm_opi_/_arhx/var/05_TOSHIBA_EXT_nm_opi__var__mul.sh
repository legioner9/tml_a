...
05_TOSHIBA_EXT_nm_opi__var__mul() {

    echo -e "${CYAN}--- 05_TOSHIBA_EXT_nm_opi__var__mul() file://${PLT_PATH}/.d/.mul/nm_opi_/var/05_TOSHIBA_EXT_nm_opi__var__mul.sh ---${NORMAL}" #sistem info mesage
    ...
    push_net_strong=
    push_local_strong="${dir_bare}/${name_repo}<>HOME_REPOBARE_BARE_${name_repo}></run/media/${USER}/TOSHIBA_EXT/REPOBARE/_bare/${name_repo}<>TOSHIBA_EXT_REPOBARE_BARE_${name_repo}"
    ...
    push_local="/run/media/${USER}/MY_ONE/REPOBARE/_bare/${name_repo}<>MY_ONE_REPOBARE_BARE_${name_repo}></run/media/${USER}/TOSH/REPOBARE/_bare/${name_repo}<>TOSH_REPOBARE_BARE_${name_repo}"
