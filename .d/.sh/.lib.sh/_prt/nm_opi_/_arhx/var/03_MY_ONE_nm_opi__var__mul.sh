...
03_MY_ONE_nm_opi__var__mul() {

    echo -e "${CYAN}--- 03_MY_ONE_nm_opi__var__mul() file://${PLT_PATH}/.d/.mul/nm_opi_/var/03_MY_ONE_nm_opi__var__mul.sh ---${NORMAL}" #sistem info mesage
